# Source: https://gateway.sanctum.so/docs/misc/tip-accounts

**Fetched:** 2025-10-28 11:41:56

---

[Skip to main content](https://gateway.sanctum.so/docs/misc/tip-accounts#content-area)
...
Misc
# Tip Accounts
This page lists the official tip account addresses associated with Gateway. These addresses are used for receiving transaction tips
**Account** | **Address**  
---|---  
Tip #1 | `9fBpwxcudpLyJskhiiKmU8wPszeUuCB8sSjhPi44QuFb`  
Tip #2 | `E8iYKQbhTywHbncCagNBbZ58JY6cX1SiYk5ZDPJeWFFq`  
Tip #3 | `AJxEGdtoHrgVUPyMsdyMLiEevwa6gk3de1QDPGwVh2hw`  
Tip #4 | `FzESY59j4xCef1EjqoprVBDXEFTWcrx8hGq6AYYvGH1v`  
Tip #5 | `77N86XfcBSAvcGNPYMAVjjyf2feUJwmUoiJ96HzPtySd`  
For any queries, reach out through our official support channels.
[Optimization](https://gateway.sanctum.so/docs/concepts/optimization)[Rate Limits](https://gateway.sanctum.so/docs/misc/rate-limits)
⌘I
